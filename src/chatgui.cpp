...
std::string imagePath = sourcePath + "images/";
...
void ChatBotFrameImagePanel::render(wxDC &dc)
{
    ...
    wxString imgFile = imagePath + "sf_bridge.jpg";
    wxImage image;
    ...
    : wxScrolledWindow(parent, id)
{
    ...
    _chatLogic->LoadAnswerGraphFromFile(sourcePath + "src/answergraph.txt");
...
{
    wxImage image;
    image.LoadFile(imagePath + "sf_bridge_inner.jpg");
    ...
    : wxPanel(parent, -1, wxPoint(-1, -1), wxSize(-1, -1), wxBORDER_NONE)
{
    ...
    _chatBotImg = new wxStaticBitmap(this, wxID_ANY, (isFromUser ? wxBitmap(imagePath + "user.png", wxBITMAP_TYPE_PNG) : *bitmap), wxPoint(-1, -1), wxSize(-1, -1));
